...
export interface ApiBlock1Block1 extends Struct.CollectionTypeSchema {
  collectionName: 'block1s';
  info: {
    displayName: 'Block1';
    pluralName: 'block1s';
    singularName: 'block1';
  ...
  attributes: {
    ...
    imageBlock1: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    imageBlock1Movile: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'tituloBlock1'>;
    tituloBlock1: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiBlock2Block2 extends Struct.CollectionTypeSchema {
  collectionName: 'block2s';
  info: {
    displayName: 'Block2';
    pluralName: 'block2s';
    singularName: 'block2';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    imageBlock2: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    ...
    product: Schema.Attribute.Relation<'oneToOne', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'tituloBlock2'>;
    tituloBlock2: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    block_1: Schema.Attribute.Relation<'oneToOne', 'api::block1.block1'>;
    block_2: Schema.Attribute.Relation<'oneToOne', 'api::block2.block2'>;
...
export interface ApiOrderItemOrderItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    slug: Schema.Attribute.UID<'orderItemName'>;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    statusOrder: Schema.Attribute.Enumeration<
      ['PENDING_PAYMENT', 'PAID', 'REJECTED', 'CANCELED']
    > &
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    newProduct: Schema.Attribute.Boolean;
    price: Schema.Attribute.Decimal;
    productName: Schema.Attribute.String;
    productName2: Schema.Attribute.String;
    promotions: Schema.Attribute.Relation<
      'manyToMany',
      'api::promotion.promotion'
    >;
    ...
    sub_category: Schema.Attribute.Relation<
      ...
      'api::sub-category.sub-category'
    >;
    temp_category: Schema.Attribute.Relation<
      'oneToOne',
      'api::temp-category.temp-category'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPromotionPromotion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    temp_categories: Schema.Attribute.Relation<
      'manyToMany',
      'api::temp-category.temp-category'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiTempCategoryTempCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'temp_categories';
  info: {
    displayName: 'TempCategory';
    pluralName: 'temp-categories';
    singularName: 'temp-category';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'tempCategoryName'>;
    tempCategoryName: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiVariantVariant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    sku: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    slug: Schema.Attribute.UID<'variantName'>;
    specs: Schema.Attribute.Text;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    nota: Schema.Attribute.Text;
    notifyEmail: Schema.Attribute.Boolean;
    notifyWhatsapp: Schema.Attribute.Boolean;
    numero: Schema.Attribute.String;
